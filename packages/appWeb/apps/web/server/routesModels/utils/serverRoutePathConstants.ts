...
export const routePageMap = {
  ...
  ORGANIZATION_EDIT_REVIEW: {
    pathname: `reviewEdit`,
    pattern: `/edit/review/${routeVariables.modelType}/${
      routeVariables.forObjectUniqueId
    }/:reviewUniqueId`
  },
  REVIEWS_LIST_FOR_MODELS_PAGE: {
    pathname: `reviewsList`,
    pattern: `/reviews/${routeVariables.modelType}/${
      routeVariables.forObjectUniqueId
  ...
  ORGANIZATION_NEW_RECIPE: {
    ...
    pattern: `/organization/recipe/new/${routeVariables.modelType}/${
      routeVariables.forObjectUniqueId
    }`
  },
  ORGANIZATION_EDIT_RECIPE: {
    pathname: `editRecipeForm`,
    pattern: `/organization/recipe/edit/${routeVariables.modelType}/${
      routeVariables.forObjectUniqueId
    }/:recipeUniqueId`
  },
  // Event

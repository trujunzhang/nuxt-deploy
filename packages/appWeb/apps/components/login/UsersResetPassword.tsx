...
interface IUsersResetPasswordState {
  newPassword: string
  message: any
  waiting?: boolean
}

export class UsersResetPassword extends React.Component<{}, IUsersResetPasswordState> {
  ...
  resetPasswordCallback(token, newPassword) {}
  ...
  render() {
    // return <Telescope.UserLoginLayout

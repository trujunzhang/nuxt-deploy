...
class S {
  ...
  /// `Delete failure`
  String get peopleInEventDeleteFailure {
    return Intl.message(
      'Delete failure',
      name: 'peopleInEventDeleteFailure',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Edit`
  String get reviewPageAppBarRightEditBtnTitle {
    return Intl.message(
      'Edit',
      name: 'reviewPageAppBarRightEditBtnTitle',
      desc: '',
      args: [],
    );
  }

...
class LoggedUser extends StatefulWidget {
  LoggedUser({Key? key, required this.iconAnimationController}) : super(key: key);
                ...
                return ScaleTransition(
                  ...
                  child: RotationTransition(
                    turns: AlwaysStoppedAnimation<double>(Tween<double>(begin: 0.0, end: 24.0)
                            .animate(
                                CurvedAnimation(parent: widget.iconAnimationController, curve: Curves.fastOutSlowIn))
                            .value /
                        360),
                    child: Container(
                      height: 120,
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: <BoxShadow>[
                          BoxShadow(
                              color: AppTheme.grey.withOpacity(0.6), offset: const Offset(2.0, 4.0), blurRadius: 8),
                        ],
                      ),
                      child: ClipRRect(

                    ...
                    : () async {
                        ...
                        if (_formKey.currentState!.saveAndValidate()) {
                          ...
                          ParseModelReviews nextModel = ParseModelReviews.updateReview(
                              model: lastModel, nextRate: reviewState.getRate(), nextExtraNote: reviewState.getBody());

                          try {
                            final firestoreDatabase = Provider.of<FirestoreDatabase>(context, listen: false);
                            await firestoreDatabase.setReview(model: nextModel); // For Restaurant.
                            await ReviewHelper(
    ...
    return Stack(
      children: [
        Container(
            width: 300,
            height: 50,
            child: Image(image: AssetImage('assets/stars/large/$rating.png'), fit: BoxFit.cover)),
        ListView.builder(
            itemCount: 5,

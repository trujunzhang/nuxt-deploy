...
class _AppHomeScreenState extends State<AppHomeScreen> with TickerProviderStateMixin {
  ...
  requestAppPermission() async {
    ...
    // Other
    Map<PermissionHandler.Permission, PermissionHandler.PermissionStatus> permissions = await [
    ...
    if (
        ...
        // &&
        permissions[PermissionHandler.Permission.storage] == PermissionHandler.PermissionStatus.granted // local store
            &&
            permissions[PermissionHandler.Permission.camera] == PermissionHandler.PermissionStatus.granted // take photo
        ) {
      setState(() {

...
import 'package:ieatta/third/flutter_auth_buttons/lib/src/button.dart';
...
void main() {
  ...
  testWidgets('Check default text style is used', (WidgetTester tester) async {
    var defaultTextStyle = TextStyle(
        fontSize: 18.0, fontFamily: "Roboto", fontWeight: FontWeight.w500, color: Colors.black.withOpacity(0.54));
  ...
  testWidgets('Check supplied text style is used', (WidgetTester tester) async {
    const suppliedTextStyle =
        TextStyle(color: Color(0xff000000), fontSize: 20, fontWeight: FontWeight.w700, fontFamily: "Roboto");
    var buttonKey = UniqueKey();

export const en = {
  ...
  'newsletter.subscribe_prompt_logged':
    'Get the best articles in your inbox every week. Subscribe to our newsletter.',
  ...
  'msg.error.folders.delete.post':
    'Unable to remove this article from your collection. Please try again.',
  ...
  'msg.success.users.sent.reset.password.email':
    'We’ve emailed you the steps to reset your password.',
  ...
  'confirm.folders.delete':
    'Are you sure you want to delete this collection? There is no way back. This is a path without return! Be brave?',
  'confirm.folders.delete.post':
    'Are you sure you want to delete this post? There is no way back. This is a path without return! Be brave?',

...
class S {
  ...
  String get alertSignOutDialogMessage {
    return Intl.message(
      'This will logout. Are you sure?',
      name: 'alertSignOutDialogMessage',
      desc: '',
      args: [],
    );
  }
  ...
  String get alertDeleteConfirmDialogMessage {
    return Intl.message(
      'This will be deleted. Are you sure?',
      name: 'alertDeleteConfirmDialogMessage',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Yes`
  String get alertDeleteConfirmDialogYes {
    return Intl.message(
      'Yes',
      name: 'alertDeleteConfirmDialogYes',
      desc: '',
      args: [],
    );
  }
  ...
  /// `delete`
  String get pageAppBarRightDeleteBtnTitle {
    return Intl.message(
      'delete',
      name: 'pageAppBarRightDeleteBtnTitle',
      desc: '',
      args: [],
    );
  }

...
import 'package:app_models/src/parse_models/parse_model_reviews.dart';
...
void main() {
  ...
  test('Map model should correctly', () {
    Map<String, dynamic> map = ParseModelReviews.fromJson(json).toJson();
  ...
  test('Empty different reviewType should correctly', () {
    ...
    // ===========================================================
    ParseModelReviews model = ParseModelReviews.create(
    ...
    // Review: <For event>
    // ===========================================================
    model = ParseModelReviews.create(
        authUserModel: authUserModel,

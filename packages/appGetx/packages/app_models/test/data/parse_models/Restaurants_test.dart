...
import 'package:app_models/src/parse_models/parse_model_restaurants.dart';
...
void main() {
  ...
  test('Map model should correctly', () {
    ParseModelRestaurants parseModelRestaurant = ParseModelRestaurants.fromJson(json);
    Map<String, dynamic> map = parseModelRestaurant.toJson();
  ...
  test('Empty restaurant should correctly', () {
    ...
    ParseModelRestaurants model = ParseModelRestaurants.create(
    ...
    // Base(5)
    expect(model.uniqueId!.isNotEmpty, true);
    ...
    expect(model.streetNumber, '');
    expect(model.route, '');
    expect(model.locality, '');
    expect(model.sublocality, '');
    expect(model.country, '');
    expect(model.postalCode, '');
    expect(model.administrativeArea, '');
  });
}
